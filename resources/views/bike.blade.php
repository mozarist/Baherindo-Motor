...
@section('content')
    <div class="space-y-2 pt-25">
        <div class="space-y-10 flex flex-col justify-center items-center">
            <h6
                class="flex gap-4 items-center text-center text-4xl font-semibold bg-gradient-to-t from-red-950 to-red-500 bg-clip-text text-transparent">
                Beli motor
