...
@section('content')
    ...
    <div class="w-3xl bg-white shadow-md rounded-xl p-5 self-center justify-self-center">
        ...
        <form action="{{ route('motor.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="file" for="image" name="gambar_motor" class="mt-1 py-2 w-full border-b border-gray-300 text-zinc-500"
